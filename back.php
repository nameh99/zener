            ...
            <div class="">
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <!--<h1 class="display-1 bold color_white content__title2">Uni</h1>-->
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3">
                        ...
                        <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" onclick="(function(){window.location.href='login2.php'})();">
                            <h4>Login</h4>
                        </button>
                    </div>
                </div>
