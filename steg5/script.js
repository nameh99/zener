  ...
  template: `
		<div class="player">
			<div class="player-controls">
				...
				<div id="mute">
					<a v-on:click.prevent="mute" title="Mute" href="#" title="Mute">
						<svg width="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
				...
				<div id="volume">
					<a v-on:click.prevent="" v-on:mouseenter="showVolume = true" v-on:mouseleave="showVolume = false" title="Volume" href="#">
						<svg width="18px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
