          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="challenges.php" class="p-3 text-decoration-none text-white bold">Challenges</a>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card category_web">
                        <div class="card-header solved" data-target="#problem_id_1" data-toggle="collapse" aria-expanded="false" aria-controls="problem_id_1">
                            Admin <span class="badge">solved</span> <span class="badge">80 points</span>
                        </div>
                        <div id="problem_id_1" class="collapse card-body">
                            <blockquote class="card-blockquote">
                                ...
                                <p> Can you find the password? Enter the password as flag in the following form: HU_CTF{passwordhere}
                                </p>
                                <a target="_blank" href="challenges\web\admin\admin.html" class="btn btn-outline-secondary btn-shadow"><span class="fa fa-download mr-2"></span>Link</a>
