...
<?php include('templates/header.php'); ?>
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="" action="register.php" method="POST">
                ...
                <div class="col-xl-10">
                    ...
                    <div class="row  hackerFont">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="pass" placeholder="Access Key">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <button class="btn btn-outline-danger btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" name="reg_user">
                            <h4>Register</h4>
                    </button>
                    <small id="registerHelp" class="mt-2 form-text text-muted">Already Registered? <a href="login2.php">Login here</a></small>
                    <small id="team" class="mt-3 form-text text-muted">Recover Key<a href="#">Recovery</a></small>
                </div>
            </div>
        </div>
    </div>
